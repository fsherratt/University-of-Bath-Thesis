\makeglossaries
\newacronym{esr}{ESR}{Energy Storage and Return}
...
\newacronym{looxv}{LOOXV}{Leave One Out Cross Validation}
...
\newacronym{fmg}{FMG}{Force Myography}
...
\newacronym{lda}{LDA}{Linear Descriminant Analysis}
