...
\begin{figure}[!hbtp]
    ...
    \centering
     ...
     \end{subfigure}
     \vspace{3pt}
    \caption[Gait trends for the right shank $x$ accelerometer and $y$ gyroscope]{Gait trends for the right shank $x$ accelerometer and $y$ gyroscope for 3~different activities. The~solid lines show the mean and the shaded area the standard deviation for n steps. Black solid---Subject 4, Red~dashed---Subject 7, Blue~dot-dash---Subject 16.}
