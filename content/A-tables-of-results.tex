...
\begin{table}[H]
    \centering
    % Maximum caption size of three lines
    \caption[Table of results for classification performance of 32 unit \glsentryshort{lstm} networks trained with varying amount of amputee subject data]{Table of results for classification performance for a 32 unit \glsentryshort{lstm} networks trained with varying amount of amputee subject data. The table shows the classification accuracy for the target user training, validation and test data sets $\pm\sigma(n = 25)$. A value of one represents 100\% correct classification.}
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.905{\scriptscriptstyle\pm0.04}$ & $0.036{\scriptscriptstyle\pm0.43}$ & $0.428{\scriptscriptstyle\pm0.05}$ & 10 \\
...
750 & $0.984{\scriptscriptstyle\pm0.01}$ & $0.013{\scriptscriptstyle\pm0.87}$ & $0.869{\scriptscriptstyle\pm0.01}$ & 8 \\
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.855{\scriptscriptstyle\pm0.10}$ & $0.096{\scriptscriptstyle\pm0.45}$ & $0.447{\scriptscriptstyle\pm0.02}$ & 8 \\
...
% Transfer learning amputee
\begin{table}[H]
    \centering
    % Maximum caption size of three lines
    \caption[Table of results for classification performance of 32 unit \glsentryshort{lstm} networks personalised to an amputee using transfer learning]{Table of results for classification performance of 32 unit \glsentryshort{lstm} networks personalised to an amputee using transfer learning. The table shows the classification accuracy for the target user training, validation and test data sets $\pm\sigma(n = 25)$. A value of one represents 100\% correct classification.}
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.997{\scriptscriptstyle\pm0.00}$ & $0.570{\scriptscriptstyle\pm0.07}$ & $0.779{\scriptscriptstyle\pm0.05}$ & 6 \\
...
750 & $0.981{\scriptscriptstyle\pm0.01}$ & $0.832{\scriptscriptstyle\pm0.02}$ & $0.898{\scriptscriptstyle\pm0.02}$ & 4 \\
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.962{\scriptscriptstyle\pm0.06}$ & $0.443{\scriptscriptstyle\pm0.04}$ & $0.727{\scriptscriptstyle\pm0.04}$ & 6 \\
...
%Transfer learning amputee - Frozen LSTM
\begin{table}[H]
    \centering
    % Maximum caption size of three lines
    \caption[Table of results for classification performance of 32 unit \glsentryshort{lstm} networks with the dense layer personalised to an amputee using transfer learning.]{Table of results for classification performance of 32 unit \glsentryshort{lstm} networks with the dense layer personalised to an amputee using transfer learning. The table shows the classification accuracy for the target user training, validation and test data sets $\pm\sigma(n = 25)$. A value of one represents 100\% correct classification.}
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.932{\scriptscriptstyle\pm0.05}$ & $0.539{\scriptscriptstyle\pm0.05}$ & $0.776{\scriptscriptstyle\pm0.02}$ & 7 \\
...
%     \phantomcaption    
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.834{\scriptscriptstyle\pm0.11}$ & $0.388{\scriptscriptstyle\pm0.06}$ & $0.686{\scriptscriptstyle\pm0.05}$ & 7 \\
...
%Transfer learning amputee - Frozen Dense
\begin{table}[H]
    \centering
    % Maximum caption size of three lines
    \caption[Table of results for classification performance of 32 unit \glsentryshort{lstm} networks with the \glsentryshort{lstm} layer personalised to an amputee using transfer learning.]{Table of results for classification performance of 32 unit \glsentryshort{lstm} networks with the \glsentryshort{lstm} layer personalised to an amputee using transfer learning. The table shows the classification accuracy for the target user training, validation and test data sets $\pm\sigma(n = 25)$. A value of one represents 100\% correct classification.}
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.978{\scriptscriptstyle\pm0.01}$ & $0.574{\scriptscriptstyle\pm0.07}$ & $0.813{\scriptscriptstyle\pm0.05}$ & 7 \\
...
750 & $0.973{\scriptscriptstyle\pm0.01}$ & $0.835{\scriptscriptstyle\pm0.02}$ & $0.892{\scriptscriptstyle\pm0.02}$ & 5 \\
    ...
    \begin{tabularx}{\textwidth}{cYYYY}
        ...
        Target Windows & Training & Validation & Testing & Average Epochs \\
        \hline
100 & $0.961{\scriptscriptstyle\pm0.04}$ & $0.442{\scriptscriptstyle\pm0.04}$ & $0.735{\scriptscriptstyle\pm0.05}$ & 8 \\
